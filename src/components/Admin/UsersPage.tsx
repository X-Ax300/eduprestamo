    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 dark:text-white">Administra usuarios del sistema</p>
        </div>
        <button
          ...
          <table className="w-full">
            ...
            <tbody className="bg-white divide-y divide-gray-200 dark:bg-gray-300 transition-colors">
              {filteredUsers.map((u) => {
                ...
                return (
                  <tr key={u.id} className="hover:bg-gray-50 dark:hover:bg-gray-400 transition-colors">
